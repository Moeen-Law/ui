...
type PaymentMetricTone = "emerald" | "blue" | "violet" | "amber" | "rose" | "teal"

const toneClasses: Record<PaymentMetricTone, string> = {
...
interface PaymentsMetricCardProps {
  title: string
  value: string
  description?: string
  icon: LucideIcon
...
export default function PaymentsMetricCard({
  title,
  value,
  description,
  icon: Icon,
