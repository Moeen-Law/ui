...
interface GovernmentProcessHistoryDrawerProps {
...
export default function GovernmentProcessHistoryDrawer({
    items,
    selectedId,
    hasNextPage,
    isFetchingNextPage,
    onLoadMore,
    onSelect,
}: GovernmentProcessHistoryDrawerProps) {
                        ...
                        <div className="flex items-start justify-between gap-3">
                            ...
                            <DrawerClose asChild>
                                <Button
                                    ...
                                    aria-label={t("governmentProcesses.history.title")}
                                >
                                    <X />
                                </Button>
                            </DrawerClose>
