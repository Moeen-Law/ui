    ...
    return (
        ...
        >
            <Card className="border-blue-500/20 shadow-2xl shadow-blue-500/10">
                    ...
                    <div className="flex flex-wrap items-start justify-between gap-4">
                        ...
                        {sources.length > 0 && (
                            <Badge variant="secondary">
                                ...
                                {t("governmentProcesses.sources.count", {
                ...
                <CardContent>
                    <Tabs defaultValue="summary" dir={i18n.dir()}>
                        <TabsList>
                            <TabsTrigger value="summary">
                                <ClipboardList data-icon="inline-start" />
                                {t("governmentProcesses.tabs.summary")}
                            </TabsTrigger>
                            <TabsTrigger value="steps">
                                <BookOpenText data-icon="inline-start" />
                                {t("governmentProcesses.tabs.steps")}
                            </TabsTrigger>
                            <TabsTrigger value="details">
                                <FileCheck2 data-icon="inline-start" />
                                {t("governmentProcesses.tabs.details")}
                            </TabsTrigger>
                            <TabsTrigger value="sources">
                                <Link2 data-icon="inline-start" />
                                {t("governmentProcesses.tabs.sources", {
                                    count: sources.length,
                                })}
                            </TabsTrigger>
                        </TabsList>
                        ...
                        <TabsContent value="sources">
                            <section className="flex flex-col gap-4">
                                ...
                                {sources.length > 0 ? (
                                    ...
                                    <div className="rounded-xl border border-dashed border-blue-500/20 bg-blue-500/5 p-4 text-sm text-muted-foreground">
                                        {t("governmentProcesses.sources.empty")}
                                    </div>
                                )}
                            </section>
                        </TabsContent>
