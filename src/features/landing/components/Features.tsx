                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    {features.map((feature, index) => (
                        <div
                            ...
                            className="group bg-[#111111] border border-[#2a2a2a] rounded-2xl p-10 transition-all duration-300 cursor-pointer animate-float hover:animate-none hover:bg-[#1a1a1a] hover:border-blue-500 hover:-translate-y-5 hover:shadow-[0_20px_40px_rgba(59,130,246,0.2)]"
                        >
