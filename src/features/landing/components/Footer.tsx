...
export function Footer() {
    ...
    return (
        <footer className="content-visibility-auto py-12 bg-background border-t border-border">
            <div className="max-w-[1280px] mx-auto px-8">
                <div className="flex flex-col md:flex-row items-center gap-6 bg-blue-500/5 border border-blue-500/20 p-8 rounded-2xl">
                    ...
                    <p className="text-muted-foreground text-center md:text-start md:ms-auto leading-relaxed font-sans text-[1.05rem]">
                        {t("footer.disclaimer")}
                    </p>
                </div>
            </div>
