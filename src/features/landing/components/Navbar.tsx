        ...
        <>
            ...
            >
                <div className="max-w-[1280px] mx-auto px-8 py-6 flex justify-between items-center relative group">
                    {/* Brand */}
                    <div className="flex items-center gap-3.5 cursor-pointer transition-transform duration-250 hover:-translate-y-[1px]">
                        <svg
                    ...
                    <div className="hidden md:flex items-center gap-12">
                        ...
                        >
                            الخدمات
                            <span className="absolute bottom-0 right-0 w-0 h-[2px] bg-gradient-to-r from-blue-500 to-amber-400 rounded-sm transition-all duration-250 group-hover:w-full"></span>
                        </a>
                        <a
                            href="#pricing"
                            className="relative text-[#a0a0a0] no-underline font-semibold text-base py-2 font-['Cairo'] transition-colors duration-250 hover:text-white"
                    ...
                    <button
                        className="md:hidden flex flex-col justify-center items-center w-10 h-10 border border-[#3a3a3a] rounded-md bg-[#111111] z-[60]"
                    ...
                    {/* White Bottom Line Effect (Applies to the whole nav on hover or scroll) */}
                    <div
                        className={`absolute bottom-0 left-0 right-0 h-[2px] bg-gradient-to-r from-transparent via-white to-transparent opacity-0 transition-opacity duration-300 ${isScrolled ? "opacity-100" : "group-hover:opacity-100"
                            }`}
                    ></div>
                </div>
            </nav>
            ...
            <AnimatePresence>
                {isMobileMenuOpen && (
                    <motion.div
                        ...
                        className="fixed inset-0 z-40 bg-[#0a0a0a] border-l border-[#2a2a2a] pl-8 pr-8 pt-32 pb-8 flex flex-col items-center md:hidden"
                    >
