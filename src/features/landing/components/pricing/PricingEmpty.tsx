    ...
    return (
        <Card className="mx-auto max-w-[720px] rounded-2xl border-border bg-card p-8 text-center shadow-sm">
            <CardHeader className="items-center px-2 pb-6">
                ...
                <CardTitle className="mb-2 font-['Cairo'] text-2xl font-bold text-foreground">
                    {t("pricing.emptyTitle")}
                </CardTitle>
                <CardDescription className="mx-auto max-w-[520px] font-['Cairo'] text-base leading-relaxed">
            ...
            <CardFooter className="justify-center bg-transparent px-2 pt-2">
                <Button 
                    ...
                    variant="default" 
                    onClick={onRetry}
                    className="h-11 rounded-xl bg-blue-500 px-8 font-['Cairo'] text-white hover:bg-blue-400"
                >
