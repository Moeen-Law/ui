        ...
        <Dialog onOpenChange={(open) => {
            ...
            <DialogContent className="max-h-[calc(100dvh-2rem)] gap-0 overflow-hidden rounded-[28px] border border-border bg-background p-0 shadow-2xl sm:max-w-2xl">
                <DialogHeader className="border-b border-border bg-muted/40 p-6 pe-14 text-start">
                    ...
                    <DialogDescription className="font-sans leading-6 text-muted-foreground">
                                ...
                                >
                                    ...
                                    <span className="min-w-0 flex-1">
                                        <span className="flex items-center justify-between gap-3">
                                            <span className="truncate font-sans text-sm font-black text-foreground">
                                                {t(item.titleKey)}
                                            </span>
                                        ...
                                        <span className="mt-1 line-clamp-3 block font-sans text-xs leading-5 text-muted-foreground">
